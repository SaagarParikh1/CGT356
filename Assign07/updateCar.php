...
<head>
    <meta charset="utf-8" />
    <title>Assign06 - Update Car</title>
    <style type="text/css">
...
<body>
    <h1 style="text-align:center">Assign06 - Update Car</h1>
        ...
        <fieldset>
            ...
            <ul>
                <li>
                    ...
                    <input name="carID" id="carID" type="hidden" size="20" maxlength="3"
                        value="<?php if ($num_results != 0) {echo (trim($row["CarID"]));} ?>" />
                </li>
                <li>
                ...
                <li><label title="CarColor" for="carColor">Color</label>
                    <input name="carColor" id="carColor" type="text" size="20" maxlength="20"
                        value="<?php if ($num_results != 0) {echo (trim($row["CarColor"]));} ?>" /></li>
                </li>
