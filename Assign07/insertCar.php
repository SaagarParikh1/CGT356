...
<head>
    <meta charset="utf-8" />
    <title>Assign06 - Insert Car</title>
    <style type="text/css">
...
<body>
    <h1 style="text-align:center">Assign06 - Insert Car</h1>
    ...
    <form id="form0" method="post" action="doInsertCar.php">
        ...
        <ul>
            ...
            <li><label title="CarModel" for="carModel">Model</label><input name="carModel" id="carModel" type="text" size="20" maxlength="30"/></li>
            ...
            <li><label title="CarYear" for="carYear">Year</label>
                ...
                <li><label title="CarColor" for="carColor">Color</label><input name="carColor" id="carColor" type="text" size="20" maxlength="30"/></li>
                <li><label title="CarHybrid" for="carHybrid">Hybrid?</label><span id="radios" style="float: right">
                <input name="carHybrid" id="carHybrid" type="radio" value="Yes" />Yes 
                <input name="carHybrid" id="carHybrid" type="radio" value="No" />No </span></li>
                <li><span></span></li>
