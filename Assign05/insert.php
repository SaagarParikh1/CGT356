...
?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 12 ▼ <head>
<meta charset="utf-8" />
<title>Assign05 - INSERT</title>
	...
	?>
		<form id="form" method="post" action="doInsert.php">

	<fieldset>
		<legend> Insert into Shipper table</legend>
		<ul>
		<li> <label title="ShipperID" for="shipper ID">Shipper ID</label> <input name="shipperID" id="shipper ID" type="text" size="20" maxlength="3"/></li> 
	...
	document.getElementById("shipper ID").focus();