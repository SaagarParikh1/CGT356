...
<title>Untitled Document</title>
	<meta charset="utf-8">
	<title>Lab02 - IndexB</title>
	<style type="text/css">
		ul {list-style:none; margin-top:5px;}
		ul li {display:block; float:left; width:100%; height: 1%;}
		ul li label {float:left; padding: 7px; color: #6666ff;}
		ul li input {float:right; margin:10px; border: 1px solid #ccc; padding: 3px; font-family: Gotham, "Helvetica Neue", Helvetica, Arial, "sans-serif"; width:60%;}
		li input:focus {border:1px solid #666;}
		...
		fieldset#submit { position: absolute; top: 300px; left: 20px; width: 460px; text-align: center;}
...
<form id="form0" name="form0" action="loginB.php" method="post">
	<fieldset id="info">
		<legend>Login</legend>
		<p>Page1B: User - page1B /// Pass - alpha<br>
			Page2B: User - page2B /// Pass - beta<br>
			Page3B: User - page3B /// Pass - gamma<br>
			Page4B: User - page4B /// Pass - delta
		</p>
