...
<form id="form0" method="post" action="getFormData.php"> 
    <fieldset id="billing">
        ...
        <ul>
            ...
            <li> <label title="Comments" for="comments">Questions or Comments <span>*</span></label> <textarea rows="5" cols="40" name="comments" id="comments">value="<?php echo($comments); ?>"</textarea></li>
        </ul>
    </fieldset>
